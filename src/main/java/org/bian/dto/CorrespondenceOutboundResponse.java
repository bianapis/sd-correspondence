 ...
 */
public class CorrespondenceOutboundResponse   {
  private String correspondenceServiceSessionReference = null;

  private String outboundCorrespondenceTaskReference = null;

  private Object outboundCorrespondenceTaskRecord = null;
  ...
  /**
   * example: CSSR7DEA general-info: bank reference - will be used to match responses `status: Provisionally Registered` bian-reference: Self 
  ...
  **/
   ...
   * @return outboundCorrespondenceTaskReference
  **/

  public String getOutboundCorrespondenceTaskReference() {
    return outboundCorrespondenceTaskReference;
  }

  public void setOutboundCorrespondenceTaskReference(String outboundCorrespondenceTaskReference) {
    this.outboundCorrespondenceTaskReference = outboundCorrespondenceTaskReference;
  }
  ...
  **/
  ...
  public Object getOutboundCorrespondenceTaskRecord() {
    return outboundCorrespondenceTaskRecord;
  }

  public void setOutboundCorrespondenceTaskRecord(Object outboundCorrespondenceTaskRecord) {
