...
public class CorrespondenceOutboundWithResponseResponse   {
  ...
  private String responseCorrespondenceRecord = null;

  private String correspondenceState = null;


  /**
   * example: CSSR724254 general-info: bank reference - will be used to match responses `status: Provisionally Registered` bian-reference: Self 
  ...
  **/
   ...
   * @return outboundCorrespondencewithResponseTaskReference
  **/

  public String getOutboundCorrespondencewithResponseTaskReference() {
    return outboundCorrespondencewithResponseTaskReference;
  }

  public void setOutboundCorrespondencewithResponseTaskReference(String outboundCorrespondencewithResponseTaskReference) {
    this.outboundCorrespondencewithResponseTaskReference = outboundCorrespondencewithResponseTaskReference;
  }
  ...
  **/
  ...
  /**
   * example: record general-info: combination of following fields `status: Provisionally Registered` bian-reference:  
  ...
  **/
  ...
  /**
   * example: template 1 general-info: the template definition used in correspondence assembly `status: Registered` isoLink1: \"[click-here](https://www.iso20022.org/standardsrepository/public/wqt/Description/mx/dico/bc/_9ju10HltEeG7BsjMvd1mEw_-739610260/elements/_9jSw9XltEeG7BsjMvd1mEw_947856562)\" bian-reference: 
  ...
  **/
  ...
  /**
   * example: EMAIL general-info: | `status: Registered` isoLink1: \"[click-here](https://www.iso20022.org/standardsrepository/public/wqt/Description/mx/dico/bc/_9lOqonltEeG7BsjMvd1mEw_-1685162102/elements/_-IizE3ltEeG7BsjMvd1mEw_1655223030)\" bian-reference: PresentationManagementSystem.ManagedPresentation.InitialCorrespondence.CommunicationMethod `status: Registered` isoLink2: \"[click-here](https://www.iso20022.org/standardsrepository/public/wqt/Description/mx/dico/bc/_9lOqonltEeG7BsjMvd1mEw_-1685162102/elements/_prF7MLbpEeGAapiw3IODVw_2145476732)\" bian-reference: PresentationManagementSystem.ManagedPresentation.InitialCorrespondence.Medium 
  ...
  **/
  ...
  /**
   * example: Current news general-info: content of inbound corresponden `status: Provisionally Registered` bian-reference: PresentationManagementSystem.ManagedPresentation.InitialCorrespondence 
