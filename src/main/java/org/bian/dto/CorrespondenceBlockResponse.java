 ...
 */
public class CorrespondenceBlockResponse   {
  private String correspondenceServiceSessionReference = null;

  private String blockCorrespondenceTaskReference = null;

  private Object blockCorrespondenceTaskRecord = null;
  ...
  /**
   * example: CSSR7245275 general-info: bank reference - will be used to match responses `status: Provisionally Registered` bian-reference: Self 
  ...
  **/
  ...
  /**
   * example: JCTR7245425 general-info: bank reference - will be used to match responses `status: Not Mapped` core-data-type-reference: BIAN::DataTypesLibrary::CoreDataTypes::ISO20022andUNCEFACT::Identifier 
   * @return blockCorrespondenceTaskReference
  **/

  public String getBlockCorrespondenceTaskReference() {
    return blockCorrespondenceTaskReference;
  }

  public void setBlockCorrespondenceTaskReference(String blockCorrespondenceTaskReference) {
    this.blockCorrespondenceTaskReference = blockCorrespondenceTaskReference;
  }


  /**
   * `status: Not Mapped` core-data-type-reference: BIAN::DataTypesLibrary::CoreDataTypes::UNCEFACT::Binary general-info: used to track processig/state of block correspondence 
   * @return blockCorrespondenceTaskRecord
  **/

  public Object getBlockCorrespondenceTaskRecord() {
    return blockCorrespondenceTaskRecord;
  }

  public void setBlockCorrespondenceTaskRecord(Object blockCorrespondenceTaskRecord) {
